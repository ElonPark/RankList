...
class MovieDayTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        callMovieAPI()
        let mwvc : MovieWeekTableViewController = callMovieAPI()
        mwvc.encodeWithCoder(<#T##aCoder: NSCoder##NSCoder#>)
    }//viewDidLoad end
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if(segue.identifier == "segue_daydetail") {
            ...
            let path  = self.movieDayTable.indexPathForCell(cell)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("dayCell") as! MdayCell!
